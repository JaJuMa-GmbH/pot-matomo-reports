# :chart_with_upwards_trend: Matomo Reports Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Matomo-Reports-Power-Toy-For-Magento-2-small.png">  

Matomo Reports Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a dashboard toy 
showing [Matomo Analytics](https://www.jajuma.de/en/jajuma-develop/extensions/matomo-analytics-extension-for-magento-2) reports in your Magento store.
...
* Real-Time number of visits in last 3 minutes
* Visitor chart + visits stats summary (visits, duration, bounce rate, actions per visit, searches...)
* Map with location of visits in recent hours
...
<td>
    <table>
     <tr>
        <td colspan="2"><b>Matomo Reports Toy</b></td>
     </tr>
     <tr>
        <td><b>Real-Time View</b><br>Dark Mode</td>
        <td><b>Real-Time View</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Real-Time-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Real-Time-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Visits View</b><br>Dark Mode</td>
        <td><b>Visits View</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Visits-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Visits-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Map View</b><br>Dark Mode</td>
        <td><b>Map View</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Map-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Matomo-Reports-Power-Toy-Map-Light.jpg"></td>
    </tr>
    </table>
</td>
...
* [Matomo Analytics](https://www.jajuma.de/en/jajuma-develop/extensions/matomo-analytics-extension-for-magento-2) v2.0.0+
...
```
composer require jajuma/pot-matomo-reports
```

## Using Matomo Reports Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Matomo Reports Toy.  
...
displaying the Matomo Reports Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Matomo_Reports_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-matomo-reports/blob/master/LICENSE)
